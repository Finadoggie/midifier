...
Most of my time was spent just finding and setting up a server.
I ended up settling on nginx for the project

Around 2 days were allocated to the actual project.
It was built in Node.js because it looked fairly easy.
